...
export default function Privacy() {
  return (
    <div className="row">
      ...
      <h1>Privacy Policy for jsonverify</h1>

      <p>
        At jsonverify, accessible from www.jsonverify.com, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by
        jsonverify and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in jsonverify. This policy is not applicable to
      ...
      <p>
        jsonverify follows a standard procedure of using log files. These files
      ...
      <p>
        ...
        advertising partners of jsonverify.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on jsonverify, which are sent
      ...
      <p>
        Note that jsonverify has no access to or control over these cookies that
      ...
      <p>
        jsonverify's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        jsonverify does not knowingly collect any Personal Identifiable
